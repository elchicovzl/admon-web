...
import { ClientCard } from '@/components/dashboard/finances/invoice-detail/client-card'
import { TotalsCard } from '@/components/dashboard/finances/invoice-detail/totals-card'
import { ItemsTable } from '@/components/dashboard/finances/invoice-detail/items-table'
